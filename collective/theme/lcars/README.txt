...
To use this skin, on a buildout based installation:
    ...
    1. Unpack collective.theme.lcars package to src/ folder of your 
    buildout
    ...
    Zope to configure collective.theme.lcars.

    If another package depends on the collective.theme.lcars egg or 
